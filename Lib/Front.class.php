...
class Front
{
	...
	public function dispatch()
	{
		...
		if (file_exists($fileName)){	
			...
			echo 'Controller is not exists';exit();	
		}
	...
	public function match($path)
	{
		...
		if ($path)
		{
			...
			//前面注册了registerModules 取pathinfo的第一个值为module,如果它存在于$this->_modules在这个数组中
			...
			//以上不一定第几个值就是什么，注意array_shift的用法
